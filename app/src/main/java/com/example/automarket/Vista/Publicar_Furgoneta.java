...
public class Publicar_Furgoneta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Publicar Furgoneta");
        ...
        EditText etCapacidadDeCarga = createEditText("Capacidad de Carga", layout);
        ...
        btnPublicar.setOnClickListener(v -> {
            ...
            String datos = "Publicando:\n" +
                    ...
                    "Capacidad de Carga: " + etCapacidadDeCarga.getText().toString();
